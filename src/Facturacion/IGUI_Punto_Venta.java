 ...
 * @author Manolo
 */
public class IGUI_Punto_Venta extends javax.swing.JInternalFrame {
    ...
    private String name_tabla = "punto_venta";
    //nombre de las columnas de la Tabla a mostrar en la Ayuda
    private String[] colum_names = {"pv_codigo","pv_descripcion"};
    //nombres reales de los Indices de la Tabla
    private String[] indices_tabla = {"PK_pv_codigo","PK_pv_descripcion"};  
    
    
    //nombres de los campos de la JTabla (formales a mostrar en la ayuda) 
    private String[] colum_names_tabla = {"Codigo Pto Venta","Descripcion"};    
    
   
    //nombres formales de los Indices de la Tabla (a mostrar en el menu ordenamiento)
    private String[] name_indicesTabla = {"por Codigo de Pto Venta","por Descripcion"};
    ...
    public IGUI_Punto_Venta(Conexion r) {
        initComponents();
        restringirCampos();
        r_con = r; 
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Gestión Punto de Venta");
        ...
        lab_descripcion.setText("Punto de Venta");
    ...
    */
    private boolean existe (int nro){
        ...
        try {
            ...
            Logger.getLogger(IGUI_Punto_Venta.class.getName()).log(Level.SEVERE, null, ex);
        } finally {            
            r_con.cierraConexion();
        }
        return existe;
    ...
    private void insertar(){             
        ...
        if(r_con.Insertar(sql)){            
                mostrar_Msj_Exito("Punto de Venta registrado en el Sistema.");
        };
    }
    ...
    private void eliminar(){
        if (!field_codigo.getText().equals("")){
            r_con.Connection();
            r_con.Borrar("DELETE FROM "+name_tabla+" WHERE pv_codigo = '"+field_codigo.getText()+"'");         
            r_con.cierraConexion();
        }
    }
    ...
    private void modificar(){
        ...
        r_con.ActualizarSinCartel("UPDATE "+name_tabla+" SET "
                + "pv_codigo = '"+field_codigo.getText()+"', "
                + "pv_descripcion = '"+field_descripcion.getText()+"' "                
                + "WHERE pv_codigo = "+field_codigo.getText());
        r_con.cierraConexion();
    }
