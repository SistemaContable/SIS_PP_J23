    ...
    */
    ...
    // End of variables declaration//GEN-END:variables
     ...
     private void ordenarFoco() { 
        field_codigo.setDocument(new JTextFieldFilter(JTextFieldFilter.NUMERIC,20));
        field_nombre.setDocument(new JTextFieldFilter(JTextFieldFilter.ALPHA_NUMERIC,20));
        field_apellido.setDocument(new JTextFieldFilter(JTextFieldFilter.ALPHA_NUMERIC,20));
        field_cuit1.setDocument(new JTextFieldFilter(JTextFieldFilter.NUMERIC,2));
        field_cuit2.setDocument(new JTextFieldFilter(JTextFieldFilter.NUMERIC,2));
        field_cuit3.setDocument(new JTextFieldFilter(JTextFieldFilter.NUMERIC,1));
        field_localidad.setDocument(new JTextFieldFilter(JTextFieldFilter.NUMERIC,5));
        field_direccion.setDocument(new JTextFieldFilter(45));
        field_calle.setDocument(new JTextFieldFilter(JTextFieldFilter.NUMERIC,10));
        field_sit_frente_iva.setDocument(new JTextFieldFilter(JTextFieldFilter.NUMERIC,2));
