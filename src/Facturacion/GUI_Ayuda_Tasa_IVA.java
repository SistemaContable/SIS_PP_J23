 ...
 * @author Manolo
 */
public class GUI_Ayuda_Tasa_IVA extends javax.swing.JInternalFrame {
    
//***********************************************************************************************************************************************************************************   
    //nombre de la Tabla del SGBD
    private final String name_tabla = "tipo_tasas_iva";
    //nombre de las columnas de la Tabla a mostrar en la Ayuda
    private final String[] colum_names = {"tasa_clave","tasa_desc"};
    //nombres reales de los Indices de la Tabla
    private final String[] indices_tabla = {"PK_Tasa_IVA"}; 
...
//***********************************************************************************************************************************************************************************
    ...
    private final String[] colum_names_tabla = {"Codigo de Tasa","Descripción"};        
...
//***********************************************************************************************************************************************************************************
    ...
    public GUI_Ayuda_Tasa_IVA(Conexion con,JInternalFrame v) {
        initComponents();        
        r_con=con;              
