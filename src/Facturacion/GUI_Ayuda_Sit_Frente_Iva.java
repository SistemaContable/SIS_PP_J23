 ...
 * @author Manolo
 */
public class GUI_Ayuda_Sit_Frente_Iva extends javax.swing.JInternalFrame {
    
//***********************************************************************************************************************************************************************************   
    //nombre de la Tabla del SGBD
    private final String name_tabla = "situacion_frente_iva";
    //nombre de las columnas de la Tabla a mostrar en la Ayuda
    private final String[] colum_names = {"sfi_id","sfi_descripcion"};
    //nombres reales de los Indices de la Tabla
    private final String[] indices_tabla = {"PK_sfi_id"}; 
...
//***********************************************************************************************************************************************************************************
    ...
    private final String[] colum_names_tabla = {"Codigo Sit. Frente Iva","Descripción"};        
...
//***********************************************************************************************************************************************************************************
    ...
    public GUI_Ayuda_Sit_Frente_Iva(Conexion con,JInternalFrame v) {
        initComponents();        
        r_con=con;              
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Ayuda Situacion Frente Iva");
