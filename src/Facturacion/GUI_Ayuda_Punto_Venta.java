 ...
 * @author Manolo
 */
public class GUI_Ayuda_Punto_Venta extends javax.swing.JInternalFrame {
    
//***********************************************************************************************************************************************************************************   
    //nombre de la Tabla del SGBD
    private final String name_tabla = "punto_venta";
    //nombre de las columnas de la Tabla a mostrar en la Ayuda
    private final String[] colum_names = {"pv_codigo","pv_descripcion"};
...
//***********************************************************************************************************************************************************************************
    ...
    private final String[] colum_names_tabla = {"Codigo P.V.","Descripción"};        
...
//***********************************************************************************************************************************************************************************
    ...
    public GUI_Ayuda_Punto_Venta(Conexion con,JInternalFrame v) {
        initComponents();        
        r_con=con;              
