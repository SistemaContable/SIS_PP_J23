 ...
 * @author Manolo
 */
public class GUI_Ayuda_Tipo_Comprobante extends javax.swing.JInternalFrame {
    
//***********************************************************************************************************************************************************************************   
    //nombre de la Tabla del SGBD
    private final String name_tabla = "tipo_comprobante";
    //nombre de las columnas de la Tabla a mostrar en la Ayuda
    private final String[] colum_names = {"tc_codigo","tc_descripcion"};
    //nombres reales de los Indices de la Tabla
    private final String[] indices_tabla = {"PK_tc_codigo"}; 
...
//***********************************************************************************************************************************************************************************
    ...
    private final String[] colum_names_tabla = {"Codigo Comprobante","Descripción"};        
...
//***********************************************************************************************************************************************************************************
    ...
    public GUI_Ayuda_Tipo_Comprobante(Conexion con,JInternalFrame v) {
        initComponents();        
        r_con=con;              
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Ayuda Tipo Comprobante");
